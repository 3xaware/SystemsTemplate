...
- **StaticDataExtractor**: Utilidad para leer datos estáticos desde archivos JSON. Se documenta en [SaveSystem.md](SaveSystem.md) porque suele alimentar inventarios u otros sistemas persistentes.
